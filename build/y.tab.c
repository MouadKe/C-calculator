...
#line 94 "/home/mk82/Documents/Fac/S5/Compilation/C-calculator/build/y.tab.c"
...
static const char *const yytname[] =
{
  ...
  "PLUS", "MINUS", "MUL", "DIV", "LPAREN", "RPAREN", "COMMA", "UNKNOWN",
  "$accept", "input", "expr", "args", YY_NULLPTR
};
...
{
       1,   -10,     8,     1,    15,    14,     1,     6,   -10,     1,
       1,     1,     1,    14,    -9,   -10,    16,    16,   -10,   -10,
     -10,     1,    14
};
...
{
       7,    20,    21,    13,     1,     2,    16,    17,    18,    19,
       3,     9,    10,    11,    12,     8,    15,     6,    22,     9,
      10,    11,    12,    11,    12
};

static const yytype_int8 yycheck[] =
{
       3,    10,    11,     6,     3,     4,     9,    10,    11,    12,
       9,     5,     6,     7,     8,     0,    10,     9,    21,     5,
       6,     7,     8,     7,     8
};
...
{
       0,     3,     4,     9,    14,    15,     9,    15,     0,     5,
       6,     7,     8,    15,    16,    10,    15,    15,    15,    15,
      10,    11,    15
};
...
#line 46 "expr.y"
            { printf("Result = %f\n", (yyvsp[0].fval)); }
#line 1098 "/home/mk82/Documents/Fac/S5/Compilation/C-calculator/build/y.tab.c"
    break;

  case 3: /* expr: expr PLUS expr  */
#line 50 "expr.y"
                        { (yyval.fval) = (yyvsp[-2].fval) + (yyvsp[0].fval); }
#line 1104 "/home/mk82/Documents/Fac/S5/Compilation/C-calculator/build/y.tab.c"
    break;

  case 4: /* expr: expr MINUS expr  */
#line 51 "expr.y"
                        { (yyval.fval) = (yyvsp[-2].fval) - (yyvsp[0].fval); }
#line 1110 "/home/mk82/Documents/Fac/S5/Compilation/C-calculator/build/y.tab.c"
    break;

  case 5: /* expr: expr MUL expr  */
#line 52 "expr.y"
                        { (yyval.fval) = (yyvsp[-2].fval) * (yyvsp[0].fval); }
#line 1116 "/home/mk82/Documents/Fac/S5/Compilation/C-calculator/build/y.tab.c"
    break;

  case 6: /* expr: expr DIV expr  */
#line 53 "expr.y"
                        { (yyval.fval) = (yyvsp[-2].fval) / (yyvsp[0].fval); }
#line 1122 "/home/mk82/Documents/Fac/S5/Compilation/C-calculator/build/y.tab.c"
    break;

  case 7: /* expr: NUMBER  */
#line 55 "expr.y"
                        { (yyval.fval) = (yyvsp[0].fval); }
#line 1128 "/home/mk82/Documents/Fac/S5/Compilation/C-calculator/build/y.tab.c"
    break;

  case 8: /* expr: IDENT LPAREN args RPAREN  */
#line 58 "expr.y"
                               {
            /* call function with that call's ArgList ($3) */
            (yyval.fval) = call_function((yyvsp[-3].sval), (yyvsp[-1].plist));

            /* free memory for args list and identifier strdup */
            free((yyvsp[-1].plist)->data);
            free((yyvsp[-1].plist));
            free((yyvsp[-3].sval));
      }
#line 1142 "/home/mk82/Documents/Fac/S5/Compilation/C-calculator/build/y.tab.c"
    break;

  case 9: /* expr: LPAREN expr RPAREN  */
#line 68 "expr.y"
                          { (yyval.fval) = (yyvsp[-1].fval); }
#line 1148 "/home/mk82/Documents/Fac/S5/Compilation/C-calculator/build/y.tab.c"
    break;
...
#line 72 "expr.y"
           {
            ...
            ArgList* al = make_args((yyvsp[0].fval));
            (yyval.plist) = al;
      }
#line 1158 "/home/mk82/Documents/Fac/S5/Compilation/C-calculator/build/y.tab.c"
    break;

  case 11: /* args: args COMMA expr  */
#line 77 "expr.y"
                      {
            /* append to the existing ArgList */
            (yyval.plist) = add_arg((yyvsp[-2].plist), (yyvsp[0].fval));
      }
#line 1167 "/home/mk82/Documents/Fac/S5/Compilation/C-calculator/build/y.tab.c"
    break;


#line 1171 "/home/mk82/Documents/Fac/S5/Compilation/C-calculator/build/y.tab.c"
